...
public class RecloserEventProfileXsdConverter
{
			...
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return RecloserEventProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return RecloserEventProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	...
	public static RecloserEventProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return RecloserEventProfileXsdConverter.fromJsonConverter.fromJson(json, RecloserEventProfile.class);
	}
}
