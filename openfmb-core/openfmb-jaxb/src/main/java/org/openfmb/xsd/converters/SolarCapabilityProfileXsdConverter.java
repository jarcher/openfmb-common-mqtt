...
public class SolarCapabilityProfileXsdConverter
{
			...
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return SolarCapabilityProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return SolarCapabilityProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	...
	public static SolarCapabilityProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return SolarCapabilityProfileXsdConverter.fromJsonConverter.fromJson(json, SolarCapabilityProfile.class);
	}
}
