 ...
 * BatteryControlProfile structure.
 * 
...
public class BatteryControlProfileXsdConverter
{
	...
	/**
	 * This method takes a POJO BatteryControlProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the BatteryControlProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryControlProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the BatteryControlProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryControlProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryControlProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryControlProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a BatteryControlProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a BatteryControlProfile object
	 * 
	 ...
	 * @throws JAXBException
	 */
	public static BatteryControlProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a BatteryControlProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a BatteryControlProfile object
	 ...
	 * @throws JAXBException
	 */
	public static BatteryControlProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojoToXml(BatteryControlProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(BatteryControlProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		jaxbMarshaller.marshal(objFactory.createBatteryControlProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a BatteryControlProfile object
	 * 
	 * @return POJO BatteryControlProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static BatteryControlProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * 
	 * @param pojo BatteryControlProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the BatteryControlProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojoToJson(BatteryControlProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an JSON representation of a BatteryControlProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a BatteryControlProfile object
	 * 
	 * @return String containing the corresponding XML representation of the BatteryControlProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
