 ...
 * ResourceStatusProfile structure.
 * 
...
public class ResourceStatusProfileXsdConverter
{
	...
	/**
	 * This method takes a POJO ResourceStatusProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the ResourceStatusProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(ResourceStatusProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the ResourceStatusProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(ResourceStatusProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(ResourceStatusProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(ResourceStatusProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a ResourceStatusProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a ResourceStatusProfile object
	 * 
	 ...
	 * @throws JAXBException
	 */
	public static ResourceStatusProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a ResourceStatusProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a ResourceStatusProfile object
	 ...
	 * @throws JAXBException
	 */
	public static ResourceStatusProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 */
	public static String convertPojoToXml(ResourceStatusProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(ResourceStatusProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		jaxbMarshaller.marshal(objFactory.createResourceStatusProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a ResourceStatusProfile object
	 * 
	 * @return POJO ResourceStatusProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static ResourceStatusProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * 
	 * @param pojo ResourceStatusProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the ResourceStatusProfile
	 */
	...
	/**
	 * This method takes an JSON representation of a ResourceStatusProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a ResourceStatusProfile object
	 * 
	 * @return String containing the corresponding XML representation of the ResourceStatusProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
