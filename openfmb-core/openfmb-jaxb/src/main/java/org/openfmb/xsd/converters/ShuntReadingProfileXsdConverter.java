...
public class ShuntReadingProfileXsdConverter
{
			...
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return ShuntReadingProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return ShuntReadingProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	...
	public static ShuntReadingProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return ShuntReadingProfileXsdConverter.fromJsonConverter.fromJson(json, ShuntReadingProfile.class);
	}
}
