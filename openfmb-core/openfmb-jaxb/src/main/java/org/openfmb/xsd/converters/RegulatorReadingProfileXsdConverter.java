...
import org.openfmb.xsd._2016._05.openfmb.regulatormodule.ObjectFactory;
import org.openfmb.xsd._2016._05.openfmb.regulatormodule.RegulatorReadingProfile;
 ...
 * RegulatorReadingProfile structure.
 * 
 * @author Dwayne Bradley
 * @version 1.0
 */
public class RegulatorReadingProfileXsdConverter
{
	...
	private RegulatorReadingProfileXsdConverter()
	{
		// Just prevent anyone from creating an instance of this class.
	}
	
	/**
	 * This method takes a POJO RegulatorReadingProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the RegulatorReadingProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorReadingProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the RegulatorReadingProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorReadingProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorReadingProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorReadingProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a RegulatorReadingProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a RegulatorReadingProfile object
	 * 
	 * @return POJO RegulatorReadingProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static RegulatorReadingProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a RegulatorReadingProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a RegulatorReadingProfile object
	 ...
	 * @throws JAXBException
	 */
	public static RegulatorReadingProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 */
	public static String convertPojoToXml(RegulatorReadingProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(RegulatorReadingProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		ByteArrayOutputStream stream = new ByteArrayOutputStream();
		
		JAXBContext jaxbContext = JAXBContext.newInstance(RegulatorReadingProfile.class);
		Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
		jaxbMarshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, formatXml);
		
		ObjectFactory objFactory = new ObjectFactory();
		
		jaxbMarshaller.marshal(objFactory.createRegulatorReadingProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a RegulatorReadingProfile object
	 * 
	 * @return POJO RegulatorReadingProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static RegulatorReadingProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		JAXBElement<RegulatorReadingProfile> root =
	 ...
	 * @param xml XML representation of a RegulatorReadingProfile object
	 * 
	 * @return String containing the corresponding JSON representation of the RegulatorReadingProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * 
	 * @param pojo RegulatorReadingProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the RegulatorReadingProfile
	 */
	public static String convertPojoToJson(RegulatorReadingProfile pojo)
			throws DatatypeConfigurationException
	{
	 ...
	 * @return String containing the corresponding JSON representation of the RegulatorReadingProfile
	 */
	public static String convertPojoToJson(RegulatorReadingProfile pojo, boolean formatJson)
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return RegulatorReadingProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return RegulatorReadingProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	
	/**
	 * This method takes an JSON representation of a RegulatorReadingProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a RegulatorReadingProfile object
	 * 
	 * @return String containing the corresponding XML representation of the RegulatorReadingProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * @throws DatatypeConfigurationException
	 */
	public static RegulatorReadingProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return RegulatorReadingProfileXsdConverter.fromJsonConverter.fromJson(json, RegulatorReadingProfile.class);
	}
}
