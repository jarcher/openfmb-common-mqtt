 ...
 * RegulatorStatusProfile structure.
 * 
 * @author Dwayne Bradley
 * @version 1.0
 */
public class RegulatorStatusProfileXsdConverter
{
	...
	private RegulatorStatusProfileXsdConverter()
	{
		// Just prevent anyone from creating an instance of this class.
	}
	
	/**
	 * This method takes a POJO RegulatorStatusProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the RegulatorStatusProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorStatusProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the RegulatorStatusProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorStatusProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorStatusProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(RegulatorStatusProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a RegulatorStatusProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a RegulatorStatusProfile object
	 * 
	 * @return POJO RegulatorStatusProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static RegulatorStatusProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a RegulatorStatusProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a RegulatorStatusProfile object
	 ...
	 * @throws JAXBException
	 */
	public static RegulatorStatusProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 */
	public static String convertPojoToXml(RegulatorStatusProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(RegulatorStatusProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		ByteArrayOutputStream stream = new ByteArrayOutputStream();
		
		JAXBContext jaxbContext = JAXBContext.newInstance(RegulatorStatusProfile.class);
		Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
		jaxbMarshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, formatXml);
		
		ObjectFactory objFactory = new ObjectFactory();
		
		jaxbMarshaller.marshal(objFactory.createRegulatorStatusProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a RegulatorStatusProfile object
	 * 
	 * @return POJO RegulatorStatusProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static RegulatorStatusProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		JAXBElement<RegulatorStatusProfile> root =
	 ...
	 * @param xml XML representation of a RegulatorStatusProfile object
	 * 
	 * @return String containing the corresponding JSON representation of the RegulatorStatusProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * 
	 * @param pojo RegulatorStatusProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the RegulatorStatusProfile
	 */
	public static String convertPojoToJson(RegulatorStatusProfile pojo)
			throws DatatypeConfigurationException
	{
	 ...
	 * @return String containing the corresponding JSON representation of the RegulatorStatusProfile
	 */
	public static String convertPojoToJson(RegulatorStatusProfile pojo, boolean formatJson)
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return RegulatorStatusProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return RegulatorStatusProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	
	/**
	 * This method takes an JSON representation of a RegulatorStatusProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a RegulatorStatusProfile object
	 * 
	 * @return String containing the corresponding XML representation of the RegulatorStatusProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * @throws DatatypeConfigurationException
	 */
	public static RegulatorStatusProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return RegulatorStatusProfileXsdConverter.fromJsonConverter.fromJson(json, RegulatorStatusProfile.class);
	}
}
