...
import org.openfmb.xsd._2015._12.openfmb.loadmodule.LoadControlProfile;
 ...
 * LoadControlProfile structure.
 * 
 * @author Dwayne Bradley
 * @version 1.0
 */
public class LoadControlProfileXsdConverter
{
	...
	private LoadControlProfileXsdConverter()
	{
		// Just prevent anyone from creating an instance of this class.
	}
	
	/**
	 * This method takes a POJO LoadControlProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the LoadControlProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadControlProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the LoadControlProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadControlProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadControlProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadControlProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a LoadControlProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a LoadControlProfile object
	 * 
	 * @return POJO LoadControlProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static LoadControlProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a LoadControlProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a LoadControlProfile object
	 ...
	 * @throws JAXBException
	 */
	public static LoadControlProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 */
	public static String convertPojoToXml(LoadControlProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(LoadControlProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		ByteArrayOutputStream stream = new ByteArrayOutputStream();
		
		JAXBContext jaxbContext = JAXBContext.newInstance(LoadControlProfile.class);
		Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
		jaxbMarshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, formatXml);
		
		ObjectFactory objFactory = new ObjectFactory();
		
		jaxbMarshaller.marshal(objFactory.createLoadControlProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a LoadControlProfile object
	 * 
	 * @return POJO LoadControlProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static LoadControlProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		JAXBElement<LoadControlProfile> root =
	 ...
	 * @param xml XML representation of a LoadControlProfile object
	 * 
	 * @return String containing the corresponding JSON representation of the LoadControlProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * 
	 * @param pojo LoadControlProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the LoadControlProfile
	 */
	public static String convertPojoToJson(LoadControlProfile pojo)
			throws DatatypeConfigurationException
	{
	 ...
	 * @return String containing the corresponding JSON representation of the LoadControlProfile
	 */
	public static String convertPojoToJson(LoadControlProfile pojo, boolean formatJson)
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return LoadControlProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return LoadControlProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	
	/**
	 * This method takes an JSON representation of a LoadControlProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a LoadControlProfile object
	 * 
	 * @return String containing the corresponding XML representation of the LoadControlProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * @throws DatatypeConfigurationException
	 */
	public static LoadControlProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return LoadControlProfileXsdConverter.fromJsonConverter.fromJson(json, LoadControlProfile.class);
	}
}
