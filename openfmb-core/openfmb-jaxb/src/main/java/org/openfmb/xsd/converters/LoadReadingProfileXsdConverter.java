...
import org.openfmb.xsd._2015._12.openfmb.loadmodule.LoadReadingProfile;
 ...
 * LoadReadingProfile structure.
 * 
 * @author Dwayne Bradley
 * @version 1.0
 */
public class LoadReadingProfileXsdConverter
{
	...
	private LoadReadingProfileXsdConverter()
	{
		// Just prevent anyone from creating an instance of this class.
	}
	
	/**
	 * This method takes a POJO LoadReadingProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the LoadReadingProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadReadingProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the LoadReadingProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadReadingProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadReadingProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(LoadReadingProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a LoadReadingProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a LoadReadingProfile object
	 * 
	 * @return POJO LoadReadingProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static LoadReadingProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a LoadReadingProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a LoadReadingProfile object
	 ...
	 * @throws JAXBException
	 */
	public static LoadReadingProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 */
	public static String convertPojoToXml(LoadReadingProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(LoadReadingProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		ByteArrayOutputStream stream = new ByteArrayOutputStream();
		
		JAXBContext jaxbContext = JAXBContext.newInstance(LoadReadingProfile.class);
		Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
		jaxbMarshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, formatXml);
		
		ObjectFactory objFactory = new ObjectFactory();
		
		jaxbMarshaller.marshal(objFactory.createLoadReadingProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a LoadReadingProfile object
	 * 
	 * @return POJO LoadReadingProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static LoadReadingProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		JAXBElement<LoadReadingProfile> root =
	 ...
	 * @param xml XML representation of a LoadReadingProfile object
	 * 
	 * @return String containing the corresponding JSON representation of the LoadReadingProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * 
	 * @param pojo LoadReadingProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the LoadReadingProfile
	 */
	public static String convertPojoToJson(LoadReadingProfile pojo)
			throws DatatypeConfigurationException
	{
	 ...
	 * @return String containing the corresponding JSON representation of the LoadReadingProfile
	 */
	public static String convertPojoToJson(LoadReadingProfile pojo, boolean formatJson)
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return LoadReadingProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return LoadReadingProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	
	/**
	 * This method takes an JSON representation of a LoadReadingProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a LoadReadingProfile object
	 * 
	 * @return String containing the corresponding XML representation of the LoadReadingProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * @throws DatatypeConfigurationException
	 */
	public static LoadReadingProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return LoadReadingProfileXsdConverter.fromJsonConverter.fromJson(json, LoadReadingProfile.class);
	}
}
