...
import org.openfmb.xsd._2015._12.openfmb.batterymodule.BatteryReadingProfile;
 ...
 * BatteryReadingProfile structure.
 * 
 * @author Dwayne Bradley
 * @version 1.0
 */
public class BatteryReadingProfileXsdConverter
{
	...
	private BatteryReadingProfileXsdConverter()
	{
		// Just prevent anyone from creating an instance of this class.
	}
	
	/**
	 * This method takes a POJO BatteryReadingProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the BatteryReadingProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryReadingProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the BatteryReadingProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryReadingProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryReadingProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(BatteryReadingProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a BatteryReadingProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a BatteryReadingProfile object
	 * 
	 * @return POJO BatteryReadingProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static BatteryReadingProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a BatteryReadingProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a BatteryReadingProfile object
	 ...
	 * @throws JAXBException
	 */
	public static BatteryReadingProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 */
	public static String convertPojoToXml(BatteryReadingProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(BatteryReadingProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		ByteArrayOutputStream stream = new ByteArrayOutputStream();
		
		JAXBContext jaxbContext = JAXBContext.newInstance(BatteryReadingProfile.class);
		Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
		jaxbMarshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, formatXml);
		
		ObjectFactory objFactory = new ObjectFactory();
		
		jaxbMarshaller.marshal(objFactory.createBatteryReadingProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a BatteryReadingProfile object
	 * 
	 * @return POJO BatteryReadingProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static BatteryReadingProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		JAXBElement<BatteryReadingProfile> root =
	 ...
	 * @param xml XML representation of a BatteryReadingProfile object
	 * 
	 * @return String containing the corresponding JSON representation of the BatteryReadingProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * 
	 * @param pojo BatteryReadingProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the BatteryReadingProfile
	 */
	public static String convertPojoToJson(BatteryReadingProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return String containing the corresponding JSON representation of the BatteryReadingProfile
	 */
	public static String convertPojoToJson(BatteryReadingProfile pojo, boolean formatJson)
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return BatteryReadingProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return BatteryReadingProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	
	/**
	 * This method takes an JSON representation of a BatteryReadingProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a BatteryReadingProfile object
	 * 
	 * @return String containing the corresponding XML representation of the BatteryReadingProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	 ...
	 * @throws JAXBException
	 */
	public static BatteryReadingProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return BatteryReadingProfileXsdConverter.fromJsonConverter.fromJson(json, BatteryReadingProfile.class);
	}
}
