...
public class LoadStatusProfileXsdConverter
{
			...
			throws DatatypeConfigurationException
	{
		if (formatJson)
		{
			return LoadStatusProfileXsdConverter.toJsonPrettyPrintConverter.toJson(pojo);
		}
		else
		{
			return LoadStatusProfileXsdConverter.toJsonConverter.toJson(pojo);
		}
	}
	...
	public static LoadStatusProfile convertJsonToPojo(String json)
			throws DatatypeConfigurationException
	{
		return LoadStatusProfileXsdConverter.fromJsonConverter.fromJson(json, LoadStatusProfile.class);
	}
}
