...
public class SolarEventProfileXsdConverter
{
	...
	/**
	 * This method takes a POJO SolarEventProfile object and translates it 
	 * into its corresponding XML representation based on the XSD definition.
	 * 
	 * @param pojo POJO object
	 * 
	 * @return XML string representing the SolarEventProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(SolarEventProfile pojo)
	 ...
	 * 
	 * @return XML or JSON string representing the SolarEventProfile pojo
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static String convertPojo(SolarEventProfile pojo, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(SolarEventProfile pojo, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @throws JAXBException
	 */
	public static String convertPojo(SolarEventProfile pojo, XsdConverterFormat format, boolean prettyPrintOutput)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	...
	/**
	 * This method takes an XML representation of a SolarEventProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a SolarEventProfile object
	 * 
	 ...
	 * @throws JAXBException
	 */
	public static SolarEventProfile convertToPojo(String input)
			throws DatatypeConfigurationException, JAXBException
	{
	...
	/**
	 * This method takes an XML or JSON representation of a SolarEventProfile object
	 * and converts it into a POJO object.
	 * 
	 * @param input XML representation of a SolarEventProfile object
	 ...
	 * @throws JAXBException
	 */
	public static SolarEventProfile convertToPojo(String input, XsdConverterFormat format)
			throws DatatypeConfigurationException, JAXBException
	{
		switch (format)
		{
	 ...
	 */
	public static String convertPojoToXml(SolarEventProfile pojo)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * @return XML string representing
	 */
	public static String convertPojoToXml(SolarEventProfile pojo, boolean formatXml)
			throws DatatypeConfigurationException, JAXBException
	{
		...
		jaxbMarshaller.marshal(objFactory.createSolarEventProfile(pojo), stream);
	 ...
	 * and converts it into a POJO object.
	 * 
	 * @param xml XML representation of a SolarEventProfile object
	 * 
	 * @return POJO SolarEventProfile object
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
	public static SolarEventProfile convertXmlToPojo(String xml)
			throws DatatypeConfigurationException, JAXBException
	{
	 ...
	 * 
	 * @param pojo SolarEventProfile POJO object
	 * 
	 * @return String containing the corresponding JSON representation of the SolarEventProfile
	 */
	...
	/**
	 * This method takes an JSON representation of a SolarEventProfile object
	 * and converts it into a XML representation.
	 * 
	 * @param json JSON representation of a SolarEventProfile object
	 * 
	 * @return String containing the corresponding XML representation of the SolarEventProfile
	 * 
	 * @throws DatatypeConfigurationException
	 * @throws JAXBException
	 */
